...
if (isset($_REQUEST['submit_search'])) {
    ...
    function PMA_getSearchSqls($table, $field, $search_str, $search_option)
    {
        ...
        $search_words    = (($search_option > 2) ? [$search_str] : explode(' ', $search_str));
...
echo '            </select>' . "\n";
$alter_select =
    '<a href="db_search.php' . PMA_generate_common_url(array_merge($url_params, ['selectall' => 1])) . '#db_search"'
    . ' onclick="setSelectOptions(\'db_search\', \'table_select[]\', true); return false;">' . $GLOBALS['strSelectAll'] . '</a>'
    . '&nbsp;/&nbsp;'
    . '<a href="db_search.php' . PMA_generate_common_url(array_merge($url_params, ['unselectall' => 1])) . '#db_search"'
