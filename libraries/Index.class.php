...
class PMA_Index
{
    ...
    static function singleton($schema, $table, $index_name = '')
    {
     ...
     * @return  array
     */
    static function getFromTable($table, $schema)
    {
        PMA_Index::_loadIndexes($table, $schema);
     ...
     */
    static function getPrimary($table, $schema)
    {
        PMA_Index::_loadIndexes($table, $schema);
     ...
     */
    static function getIndexChoices()
    {
        return [
            'PRIMARY',
            'INDEX',
     ...
     */
    static function getView($table, $schema, $print_mode = false)
    {
     ...
     */
    static function findDuplicates($table, $schema)
    {
        $indexes = PMA_Index::getFromTable($table, $schema);
