...
class PMA_Message
{
     ...
     * @return  PMA_Message
     */
    static function raw($message, $type = PMA_Message::NOTICE)
    {
     ...
     * @return  PMA_Message
     */
    static function rawError($message)
    {
     ...
     * @return  PMA_Message
     */
    static function rawWarning($message)
    {
     ...
     * @return  PMA_Message
     */
    static function rawNotice($message)
    {
     ...
     * @return  PMA_Message
     */
    static function rawSuccess($message)
    {
     ...
     * @access  public
     */
    static function sanitize($message)
    {
        if (is_array($message)) {
     ...
     * @access  public
     */
    static function decodeBB($message)
    {
        $replace_pairs = [
