...
$CG_FORMATS = [CG_FORMAT_NHIBERNATE_CS, CG_FORMAT_NHIBERNATE_XML];
$CG_HANDLERS = [CG_HANDLER_NHIBERNATE_CS_BODY, CG_HANDLER_NHIBERNATE_XML_BODY];
    ...
    $plugin_list['codegen'] = [
        ...
        'mime_type' => 'text/cs',
          'options' => [
            ...
            ['type' => 'select', 'name' => 'format', 'text' => 'strFormat', 'values' => $CG_FORMATS],
            ],
