...
if (isset($plugin_list)) {
    $plugin_list['csv'] = [
        ...
        'options' => [
            ['type' => 'text', 'name' => 'separator', 'text' => 'strFieldsTerminatedBy'],
            ['type' => 'text', 'name' => 'enclosed', 'text' => 'strFieldsEnclosedBy'],
            ['type' => 'text', 'name' => 'escaped', 'text' => 'strFieldsEscapedBy'],
            ['type' => 'text', 'name' => 'terminated', 'text' => 'strLinesTerminatedBy'],
