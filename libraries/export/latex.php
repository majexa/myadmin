...
if (isset($plugin_list)) {
    ...
    $plugin_list['latex'] = [
        ...
        'options' => [
            ['type' => 'bool', 'name' => 'caption', 'text' => 'strLatexIncludeCaption'],
            ],
    ...
    if (!$hide_structure) {
        ...
        $plugin_list['latex']['options'][] =
            ['type' => 'text', 'name' => 'structure_caption', 'text' => 'strLatexCaption'];
        $plugin_list['latex']['options'][] =
            ['type' => 'text', 'name' => 'structure_continued_caption', 'text' => 'strLatexContinuedCaption'];
        $plugin_list['latex']['options'][] =
            ['type' => 'text', 'name' => 'structure_label', 'text' => 'strLatexLabel'];
        if (!empty($GLOBALS['cfgRelation']['relation'])) {
            $plugin_list['latex']['options'][] =
                ['type' => 'bool', 'name' => 'relation', 'text' => 'strRelations'];
        }
        $plugin_list['latex']['options'][] =
            ['type' => 'bool', 'name' => 'comments', 'text' => 'strComments'];
    ...
    $plugin_list['latex']['options'][] =
        ['type' => 'text', 'name' => 'data_caption', 'text' => 'strLatexCaption'];
    $plugin_list['latex']['options'][] =
        ['type' => 'text', 'name' => 'data_continued_caption', 'text' => 'strLatexContinuedCaption'];
    $plugin_list['latex']['options'][] =
        ['type' => 'text', 'name' => 'data_label', 'text' => 'strLatexLabel'];
    $plugin_list['latex']['options'][] =
