...
if (isset($plugin_list)) {
    ...
    if (!$hide_sql) {
        $plugin_list['sql'] = [
            ...
            'options' => [
                ['type' => 'text', 'name' => 'header_comment', 'text' => 'strAddHeaderComment'],
                ['type' => 'bool', 'name' => 'include_comments', 'text' => 'strComments'],
                ['type' => 'bool', 'name' => 'use_transaction', 'text' => 'strEncloseInTransaction'],
                ['type' => 'bool', 'name' => 'disable_fk', 'text' => 'strDisableForeignChecks'],
                ],
        ...
        if (count($compats) > 0) {
            ...
            $plugin_list['sql']['options'][] =
                ['type' => 'select', 'name' => 'compatibility', 'text' => 'strSQLCompatibility', 'values' => $values, 'doc' => ['manual_MySQL_Database_Administration', 'Server_SQL_mode']];
            unset($values);
        }
        ...
        if ($plugin_param['export_type'] == 'server') {
            $plugin_list['sql']['options'][] =
                ['type' => 'bgroup', 'text' => 'strDatabaseExportOptions'];
            $plugin_list['sql']['options'][] =
                ['type' => 'bool', 'name' => 'drop_database', 'text' => sprintf($GLOBALS['strAddClause'], 'DROP DATABASE')];
            $plugin_list['sql']['options'][] =
                ['type' => 'egroup'];
        }
        ...
        if (!$hide_structure) {
            $plugin_list['sql']['options'][] =
                ['type' => 'bgroup', 'name' => 'structure', 'text' => 'strStructure', 'force' => 'data'];
		...
		if (PMA_MYSQL_INT_VERSION > 50100) {
            ...
            $plugin_list['sql']['options'][] =
                ['type' => 'bool', 'name' => 'drop_table', 'text' => sprintf($GLOBALS['strAddClause'], $drop_clause)];
            $plugin_list['sql']['options'][] =
                ['type' => 'bool', 'name' => 'if_not_exists', 'text' => sprintf($GLOBALS['strAddClause'], 'IF NOT EXISTS')];
            $plugin_list['sql']['options'][] =
                ['type' => 'bool', 'name' => 'auto_increment', 'text' => 'strAddAutoIncrement'];
            $plugin_list['sql']['options'][] =
                ['type' => 'bool', 'name' => 'backquotes', 'text' => 'strUseBackquotes'];
            $plugin_list['sql']['options'][] =
                ['type' => 'bool', 'name' => 'procedure_function', 'text' => sprintf($GLOBALS['strAddClause'], 'CREATE PROCEDURE / FUNCTION' . (PMA_MYSQL_INT_VERSION > 50100 ? ' / EVENT' : ''))];

            /* MIME stuff etc. */
            $plugin_list['sql']['options'][] =
                ['type' => 'bgroup', 'text' => 'strAddIntoComments'];
            $plugin_list['sql']['options'][] =
                ['type' => 'bool', 'name' => 'dates', 'text' => 'strCreationDates'];
            if (!empty($GLOBALS['cfgRelation']['relation'])) {
                $plugin_list['sql']['options'][] =
                    ['type' => 'bool', 'name' => 'relation', 'text' => 'strRelations'];
            }
            if (!empty($GLOBALS['cfgRelation']['mimework'])) {
                $plugin_list['sql']['options'][] =
                    ['type' => 'bool', 'name' => 'mime', 'text' => 'strMIME_MIMEtype'];
            }
            $plugin_list['sql']['options'][] =
                ['type' => 'egroup'];
        ...
        /* Data */
        $plugin_list['sql']['options'][] =
            ['type' => 'bgroup', 'name' => 'data', 'text' => 'strData', 'force' => 'structure'];
        $plugin_list['sql']['options'][] =
            ['type' => 'bool', 'name' => 'columns', 'text' => 'strCompleteInserts', 'doc' => ['programs', 'mysqldump', 'option_mysqldump_complete-insert-option']];
        $plugin_list['sql']['options'][] =
            ['type' => 'bool', 'name' => 'extended', 'text' => 'strExtendedInserts', 'doc' => ['programs', 'mysqldump', 'option_mysqldump_extended-insert-option']];
        $plugin_list['sql']['options'][] =
            ['type' => 'text', 'name' => 'max_query_size', 'text' => 'strMaximalQueryLength'];
        $plugin_list['sql']['options'][] =
            ['type' => 'bool', 'name' => 'delayed', 'text' => 'strDelayedInserts'];
        $plugin_list['sql']['options'][] =
            ['type' => 'bool', 'name' => 'ignore', 'text' => 'strIgnoreInserts'];
        $plugin_list['sql']['options'][] =
            ['type' => 'bool', 'name' => 'hex_for_blob', 'text' => 'strHexForBLOB'];
        $plugin_list['sql']['options'][] =
            ['type' => 'select', 'name' => 'type', 'text' => 'strSQLExportType', 'values' => ['INSERT' => 'INSERT', 'UPDATE' => 'UPDATE', 'REPLACE' => 'REPLACE']];
        $plugin_list['sql']['options'][] =
            ['type' => 'egroup'];
    }
} else {
