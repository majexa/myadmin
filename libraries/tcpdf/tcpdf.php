	...
	*/
	class TCPDF {
		...
		*/
		 ...
		 * @since 1.53.0.TC017
		 */
		private $prevFillColor = [255,255,255];
    ...
    private $n_js;
		...
		public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding="UTF-8") {
			...
			if(is_string($format)) {
				...
				switch (strtoupper($format)){
					case '4A0': {$format = [4767.87,6740.79]; break;}
					case '2A0': {$format = [3370.39,4767.87]; break;}
					case 'A0': {$format = [2383.94,3370.39]; break;}
					case 'A1': {$format = [1683.78,2383.94]; break;}
					case 'A2': {$format = [1190.55,1683.78]; break;}
					case 'A3': {$format = [841.89,1190.55]; break;}
					case 'A4': default: {$format = [595.28,841.89]; break;}
					case 'A5': {$format = [419.53,595.28]; break;}
					case 'A6': {$format = [297.64,419.53]; break;}
					case 'A7': {$format = [209.76,297.64]; break;}
					case 'A8': {$format = [147.40,209.76]; break;}
					case 'A9': {$format = [104.88,147.40]; break;}
					case 'A10': {$format = [73.70,104.88]; break;}
					case 'B0': {$format = [2834.65,4008.19]; break;}
					case 'B1': {$format = [2004.09,2834.65]; break;}
					case 'B2': {$format = [1417.32,2004.09]; break;}
					case 'B3': {$format = [1000.63,1417.32]; break;}
					case 'B4': {$format = [708.66,1000.63]; break;}
					case 'B5': {$format = [498.90,708.66]; break;}
					case 'B6': {$format = [354.33,498.90]; break;}
					case 'B7': {$format = [249.45,354.33]; break;}
					case 'B8': {$format = [175.75,249.45]; break;}
					case 'B9': {$format = [124.72,175.75]; break;}
					case 'B10': {$format = [87.87,124.72]; break;}
					case 'C0': {$format = [2599.37,3676.54]; break;}
					case 'C1': {$format = [1836.85,2599.37]; break;}
					case 'C2': {$format = [1298.27,1836.85]; break;}
					case 'C3': {$format = [918.43,1298.27]; break;}
					case 'C4': {$format = [649.13,918.43]; break;}
					case 'C5': {$format = [459.21,649.13]; break;}
					case 'C6': {$format = [323.15,459.21]; break;}
					case 'C7': {$format = [229.61,323.15]; break;}
					case 'C8': {$format = [161.57,229.61]; break;}
					case 'C9': {$format = [113.39,161.57]; break;}
					case 'C10': {$format = [79.37,113.39]; break;}
					case 'RA0': {$format = [2437.80,3458.27]; break;}
					case 'RA1': {$format = [1729.13,2437.80]; break;}
					case 'RA2': {$format = [1218.90,1729.13]; break;}
					case 'RA3': {$format = [864.57,1218.90]; break;}
					case 'RA4': {$format = [609.45,864.57]; break;}
					case 'SRA0': {$format = [2551.18,3628.35]; break;}
					case 'SRA1': {$format = [1814.17,2551.18]; break;}
					case 'SRA2': {$format = [1275.59,1814.17]; break;}
					case 'SRA3': {$format = [907.09,1275.59]; break;}
					case 'SRA4': {$format = [637.80,907.09]; break;}
					case 'LETTER': {$format = [612.00,792.00]; break;}
					case 'LEGAL': {$format = [612.00,1008.00]; break;}
					case 'EXECUTIVE': {$format = [521.86,756.00]; break;}
					case 'FOLIO': {$format = [612.00,936.00]; break;}
		...
		*/
		public function AddFont($family, $style='', $file='') {
			...
			if($this->isunicode) {
				$this->fonts[$fontkey] = ['i'=>$i, 'type'=>$type, 'name'=>$name, 'desc'=>$desc, 'up'=>$up, 'ut'=>$ut, 'cw'=>$cw, 'enc'=>$enc, 'file'=>$file, 'ctg'=>$ctg];
