...
$sections = [
    ...
    'com'           => ['title' => ''],
    'query'         => ['title' => $strSQLQuery],
    'innodb'        => ['title' => 'InnoDB'],
    'ndb'           => ['title' => 'NDB'],
    'ssl'           => ['title' => 'SSL'],
    'handler'       => ['title' => $strHandler],
    'qcache'        => ['title' => $strQueryCache],
    'threads'       => ['title' => $strThreads],
    'binlog_cache'  => ['title' => $strBinaryLog],
    'created_tmp'   => ['title' => $strTempData],
    'delayed'       => ['title' => $strServerStatusDelayedInserts],
    'key'           => ['title' => $strKeyCache],
    'select'        => ['title' => $strJoins],
    'repl'          => ['title' => $strReplication],
    'sort'          => ['title' => $strSorting],
    'table'         => ['title' => $strNumTables],
    'tc'            => ['title' => $strTransactionCoordinator],
];
