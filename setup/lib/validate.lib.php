...
{
    $result = ['Server' => '', 'Servers/1/user' => '', 'Servers/1/SignonSession' => '', 'Servers/1/SignonURL' => ''];
    $error = false;
...
{
    $tables = ['Servers/1/bookmarktable', 'Servers/1/relation', 'Servers/1/table_info', 'Servers/1/table_coords', 'Servers/1/pdf_pages', 'Servers/1/column_info', 'Servers/1/history', 'Servers/1/designer_coords'];
    $result = ['Server_pmadb' => '', 'Servers/1/controluser' => '', 'Servers/1/controlpass' => ''];
    $error = false;
...
{
    return [$path => test_number($path, $values, false, false, 65536, 'error_incorrect_port')];
}
...
{
    return [$path => test_number($path, $values, false, false, PHP_INT_MAX, 'error_nan_p')];
}
...
{
    return [$path => test_number($path, $values, false, true, PHP_INT_MAX, 'error_nan_nneg')];
}
?>