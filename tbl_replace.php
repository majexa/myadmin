...
// Check parameters
PMA_checkParameters(['db', 'table', 'goto']);
...
if (isset($_REQUEST['after_insert'])
 && in_array($_REQUEST['after_insert'], ['new_insert', 'same_insert', 'edit_next'])) {
...
if (isset($_REQUEST['primary_key'])) {
    ...
    $loop_array = (is_array($_REQUEST['primary_key']) ? $_REQUEST['primary_key'] : [$_REQUEST['primary_key']]);
    $using_key  = true;
